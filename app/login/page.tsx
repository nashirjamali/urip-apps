            ...
            >
              ...
              <motion.div variants={itemVariants} className="text-center">
                ...
                <p className="text-gray-400 text-xl max-w-2xl mx-auto leading-relaxed">
                  Connect your wallet to access the future of tokenized
                  investments
                </p>
              </motion.div>
              ...
              <motion.div variants={itemVariants}>
                <GlassCard className="p-10 relative overflow-hidden">
                  ...
                  <CardHeader className="px-0 pb-8">
                    <CardTitle className="text-4xl font-bold text-white text-center mb-2">
                      Sign In
                    </CardTitle>
                      ...
                      <div className="space-y-8">
                        <div className="relative">
                          ...
                          <div className="relative flex justify-center text-sm uppercase">
                            <span className="bg-black px-6 text-gray-400 font-medium tracking-wider">
                              Select Wallet
                            </span>
                          </div>
                        </div>
